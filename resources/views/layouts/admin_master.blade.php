...
<html lang="en">
    <head>
        ...
        <style>
            .navbar-custom {
                background-color: #212529    !important; /* Pure Black */
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseEmployees" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('employees.add_employee') }}">Add Employee</a>
                                    <a class="nav-link" href="{{ route('employees.employee') }}">Employee List</a>
                                </nav>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Het Patel,Krish Patel</div>
                            <div>
